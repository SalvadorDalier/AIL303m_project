...
_(Tài liệu này cung cấp luận điểm logic và chiều sâu kỹ thuật cho từng Slide, dùng làm tài liệu nền tảng để thiết kế PowerPoint và bảo vệ trước Hội đồng)_

---

## Slide 1: Đặt vấn đề & Thách thức cốt lõi (Problem Statement)

- \*\*Nội dung hiển thị (Visual):![alt text](data_imbalance_chart-1.png)
...
- \*\*Nội dung hiển thị (Visual):![alt text](dataset_split_chart-1.png)
- **Phân tích chuyên sâu (In-depth):**
...
- \*\*Nội dung hiển thị (Visual):![alt text](preprocessing_pipeline.drawio-1.png)
- **Phân tích chuyên sâu (In-depth):**
...
- **Nội dung hiển thị (Visual):** ![alt text](image-1.png)
- **Phân tích chuyên sâu (In-depth):**
  - Dự án khai thác 5 kiến trúc hàng đầu: GoogLeNet, DenseNet-121, ResNet-50, VGG-16, VGG-19.
  - **Cơ chế hoạt động:** Dùng feature extractor. Đóng băng các lớp layer đầu ['require_grad = False'].
  - Giữ lại ConvNet trong CNN và bỏ đi FCs. Sau đó dùng output của ConvNet còn lại để làm input cho Logistic Regression với nhiều output.
...
- **Nội dung hiển thị (Visual):** file excel
- **Phân tích chuyên sâu (In-depth):**
...
- **Nội dung hiển thị (Visual):** ![alt text](slide10.png)
- **Phân tích chuyên sâu (In-depth):**
