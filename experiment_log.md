...
|-|-|-|-|-|-|-|-|-|-|
|1|2026-06-28|VGG16|36|0.001|5|Adam|0.26652 / 0.18486|92.8% / 93.2%||
...
* **Ghi chú / Đánh giá:**
  ...
  * Train và val acc lại thấp hơn cả 2 vgg (có thể do thiếu data, chạy ít epoch, hoặc model đang học suộc thay vì học thật)
